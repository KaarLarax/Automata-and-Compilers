...
instruccion:
    ...
    | SI '(' expr ')' instrucciones SINO instrucciones {
        if ($3) {
            $$ = $5;  // Ejecutar las instrucciones del bloque "si"
        } else {
            $$ = $7;  // Ejecutar las instrucciones del bloque "sino"
        }
    }
    | SI '(' expr ')' instrucciones {
        if ($3) {
            $$ = $5;  // Ejecutar las instrucciones del bloque "si"
        }
    }
